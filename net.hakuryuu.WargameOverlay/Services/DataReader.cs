...
namespace net.hakuryuu.WargameOverlay.Services
{
    public class DataReader : IDataReader
    {
        ...
        private const string HEADER_END = "22 2C 22 50 6C 61 79 65 72 49 6E 63 6F 6D 65 52 61 74 65 22 3A 22 37 22 7D 7D 00 00 00 00 00 00 00 00 00 00 00 00 00 00";
